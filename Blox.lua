...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderImageUI.BackgroundColor3 = Color3.fromRGB(238, 130, 238)
...
Logo.Image = "rbxassetid://12511245910"
  ...
  Hub.Text = " Ryzzy Hub"
  Hub.TextColor3 = Color3.fromRGB(245, 245, 245)
  Hub.TextSize = 14.000
...
--------------------------------------------------------------------
local Library = Update:Window("YagoX HUB ","")
------------------------------------------
...
wait(1)
Notification:Notify(
   {Title = "YagoX HUB", Description = "You Have Max Observation"},
